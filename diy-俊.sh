...
#版本号
sed -i 's/1.0.0/1.2.1/g' $CURRENT_DIR/$DIR/app/build.gradle
...
sed -i 's/关于/关于\\n1.2.1/g' $CURRENT_DIR/$DIR/app/src/main/res/layout/fragment_model.xml
#sed -i 's/1.0.0 /1.2.1/g' $CURRENT_DIR/$DIR/app/src/main/res/layout/fragment_model.xml
...
#首页多排
sed -i 's/380+200*spanCount/680+600*spanCount/g'  $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/ui/activity/HomeActivity.java
