...
sed -i 's/tvFind"/tvFind" android:visibility="gone"/g' $CURRENT_DIR/$DIR/app/src/main/res/layout/activity_home.xml
sed -i 's/tvMenu"/tvMenu" android:visibility="gone"/g' $CURRENT_DIR/$DIR/app/src/main/res/layout/activity_home.xml
