...
sed -i 's/"00:00"/ "片头01:00"/'  $CURRENT_DIR/$DIR/app/src/main/res/layout/player_vod_control_view.xml
...
sed -i 's/\"@color/color_CCFFFFFF\"/ \"@color/color_00FFFFFF\"/g' $CURRENT_DIR/$DIR/app/src/main/res/layout/fragment_user.xml
