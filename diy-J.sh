...
#版本号
sed -i '/android:versionName="1.0.0"/a $CURRENT_DIR/$DIR/app/src/main/AndroidManifest.xml
...
sed -i 's/关于/关/g'  $CURRENT_DIR/$DIR/app/src/main/res/layout/fragment_model.xml
